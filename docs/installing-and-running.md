...
1. Run app configuration
   ...
   > You should run this command only the first time on initialization of your project, all next time skip it.
   >
   > If you want to contribute to the boilerplate, you should NOT run this command. > If you want to contribute to the boilerplate, you should NOT run this command.
